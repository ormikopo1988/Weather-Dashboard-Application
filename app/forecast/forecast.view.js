(function () {
	angular.module("app.forecast")
		.directive("orestisForecast", function() {
			return {
				restrict: "AE",
				replace: true,
				scope: {
			...
			function linkFn(scope, element, attrs) {
				...
				function onDPChange(newDP) { //newDP will be passed from forecast controller as an attribute of the custom directive orestis-chart in the view
					if(newDP) {
						initOptions(newDP); //for generating the data
						render(); //for rendering the chart
					}
				}
